...
def fungsiinsert():
    ...
    data = ("0002", "1945", "The Next", "Sandrea Hirata", "Gramedia", "2040", "20")
...
def fungsidelete():
    ...
    dbcursor = con.cursor()
    sql = "delete from buku where kode_buku = '5944'"
    dbcursor.execute(sql)
...
def fungsibuat():
    ...
    dbcursor = con.cursor()
    sql = "insert into buku (id_buku,kode_buku,judul_buku,penulis_buku,penerbit_buku,tahun_penerbit,stok) values(%s,%s,%s,%s,%s,%s,%s)"
    data = ("0005", "3134", "Laskar Pelangi", "Andrea Hirata", "Gramedia", "2010", "10")
